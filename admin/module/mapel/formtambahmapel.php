...
<div class="col-12 mt-5">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title"><i class="ti-save"></i> Form tambah mapel</h4>
                <form action="module/mapel/tambahMapel.php" method="POST">
                <div class="form-group">
                    <label for="example-text-input" class="col-form-label">Nama mapel</label>
                    <input class="form-control input-rounded" type="text" id="example-text-input" name="nama_mapel" required>
                </div>
                <div class="form-group">
